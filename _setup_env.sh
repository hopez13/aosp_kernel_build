...
# Use ISO 8601 format for KBUILD_BUILD_TIMESTAMP. This ensures `date -d` can parse
# this value later, no matter what strptime it is using.
export KBUILD_BUILD_TIMESTAMP="$(date -Is -u -d @${SOURCE_DATE_EPOCH})"
