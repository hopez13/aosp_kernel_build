...
| <a id="kernel_compile_commands-deps"></a>deps |  The `kernel_build`, `kernel_module` or `ddk_module` targets to extract from.   | <a href="https://bazel.build/concepts/labels">List of labels</a> | optional |  `[]`  |
...
| <a id="ddk_module-linux_includes"></a>linux_includes |  See [`ddk_headers.linux_includes`](#ddk_headers-linux_includes)   |  `None` |
