...
class CheckConfig:
    ...
    def __post_init__(self):
        self.actual = self._parse_config(self.dot_config, is_dot_config=True)
        self.expected = self._merge_post_defconfig_fragments(
            self._parse_config(fragment, is_dot_config=False)
    ...
    @staticmethod
    def _merge_post_defconfig_fragments(fragments: Iterable[ParsedConfig]) \
            -> MergedPostDefconfig:
        ...
        The `fragments` iterable is drained after the function ends.
        """
