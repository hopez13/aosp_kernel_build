...
kernel_compile_commands = rule(
    ...
    attrs = {
        ...
        "deps": attr.label_list(
            doc = """The `kernel_build`, `kernel_module` or `ddk_module` targets to extract from.

                Note: Building compdb for external modules is experimental.
                See [compile_commands.md](../compile_commands.md).
            """,
            providers = [CompileCommandsInfo],
        ),
