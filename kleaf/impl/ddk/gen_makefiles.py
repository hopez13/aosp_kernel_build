            ...
            with open(dst_path, "a") as dst, \
                ...
                if dst_path.suffix in (".c", ".rs", ".h"):
                    if dst_path.name == "ddk_marker.c":
                        if ddk_marker_written:
                            continue
                        ddk_marker_written.append(True)
...
def gen_ddk_makefile(
    ...
    ddk_marker_written = [] # Pass by Object
    for submodule_makefile_dir in submodule_makefiles:
        _merge_directories(
            output_makefiles, submodule_makefile_dir, ddk_marker_written)
