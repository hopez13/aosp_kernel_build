...
def _build_main_action(
    ...
    command += """
         ...
         # Actual kernel build
           ...
           # Allow an empty make_goals attribute to trigger just "make" in the
           # kernel directory to build the default (vmlinux) target.
           #
           # This aligns with the expectation of an empty make_goals attribute
           # building the default target.
           if [[ -n "${{make_subgoals}}" ]] || [[ -z "{make_goals}" ]]; then
