...
def _boot_images_impl(ctx):
    ...
    command += """
             # Build boot images
               (
                 ...
                 RAMDISK_COMPRESS={quoted_ramdisk_compress}
                 RAMDISK_DECOMPRESS={quoted_ramdisk_decompress}
                 RAMDISK_EXT={quoted_ramdisk_ext}
                 build_boot_images
               )
    ...
    """.format(
        ...
        quoted_ramdisk_compress = shell.quote(ramdisk_options.ramdisk_compress),
        quoted_ramdisk_decompress = shell.quote(ramdisk_options.ramdisk_decompress),
        quoted_ramdisk_ext = shell.quote(ramdisk_options.ramdisk_ext),
    )
