...
""")
        self.assertEqual(
            ...
            CheckConfig._parse_dot_config(self.dot_config),
            {
                ...
                "CONFIG_D": ConfigValue("n", self.dot_config),
            },
        )
...
""")
        self.assertEqual(
            # pylint: disable=protected-access
            CheckConfig._parse_defconfig(self.defconfig),
            {
                ...
                "CONFIG_D": ConfigValue("n", self.defconfig),
                "CONFIG_E": ConfigValue("y", self.defconfig, "this is a test"),
                "CONFIG_F": ConfigValue("n", self.defconfig),
...
""")
        self.assertEqual(
            ...
            CheckConfig._merge_post_defconfig_fragments(
                [CheckConfig._parse_defconfig(self.defconfig),
                 CheckConfig._parse_defconfig(self.defconfig2)]),
            [
                ("CONFIG_A", ConfigValue("y", self.defconfig)),
                ("CONFIG_B", ConfigValue("y", self.defconfig)),
                ("CONFIG_A", ConfigValue("n", self.defconfig2, "not enforced")),
...
"""
    ...
    def test_check_fail(self):
        self._test_check_common(
            "CONFIG_A=y\n", ["# CONFIG_A is not set\n"], [
                Mismatch("CONFIG_A",
                         ConfigValue("n", self.tempdir_path / "defconfig0"),
    ...
    def test_merge_conflicting_y(self):
        self._test_check_common(
            ...
            [
                Mismatch("CONFIG_A",
                         ConfigValue("n", self.tempdir_path / "defconfig1"),
                         ConfigValue("y", self.dot_config))
            ], [])
