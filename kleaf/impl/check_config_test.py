...
"""
    ...
    def test_check_fail(self):
        self._test_check_common(
            ...
            defconfig_contents=["# CONFIG_A is not set\n"],
            expected_errors=[
                Mismatch("CONFIG_A",
    ...
    def test_check_warn(self):
        self._test_check_common(
            dot_config_content="# CONFIG_A is not set\n",
            defconfig_contents=["CONFIG_A=y # nocheck\n"],
            expected_errors=[],
            expected_warnings=[
                Mismatch("CONFIG_A",
    ...
    def test_check_warn_opposite(self):
        self._test_check_common(
            dot_config_content="CONFIG_A=y\n",
            defconfig_contents=["# CONFIG_A is not set # nocheck\n"],
            expected_errors=[],
            expected_warnings=[
                Mismatch("CONFIG_A",
                         ConfigValue("", self.tempdir_path / "defconfig0",
